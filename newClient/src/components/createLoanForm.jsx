  ...
  render() {
    return (
      <form className='form-inline'>
        ...
        <div className="form-group">
          <button onClick={this.transaction} name="loan" type="submit" className="btn btn-danger">Loan</button>
        </div>

        <div className="form-group">
          <button onClick={this.transaction} name="borrow" type="submit" className="btn btn-success">Borrow</button>
        </div>
